Public Class FormSettings
    ...
    Private Sub ButtonProdukSave_Click(sender As Object, e As EventArgs) Handles ButtonProdukSave.Click
        ...
        Dim alamat = TextBoxAlamat1.Text
    ...
    Private Sub DataGridViewCustomer_CellMouseClick(sender As Object, e As DataGridViewCellMouseEventArgs) Handles DataGridViewCustomer.CellMouseClick
        ...
        Try
            ...
            If rdDB.HasRows Then
                ...
                TextBoxAlamat1.Text = rdDB.Item("alamat")
            End If
            rdDB.Close()
        Catch ex As Exception
            MsgBox(ex.ToString)
    ...
    Sub LoadIdentitas()
        Try
            ...
            If rdDB.HasRows Then
                ...
                POSMAIN.LabelToko = rdDB.Item("nama_toko")
                POSMAIN.LabelSubToko = rdDB.Item("alamat") + ". Telp. " + rdDB.Item("telepon")
    ...
    Private Sub ButtonSimpan_Click(sender As Object, e As EventArgs) Handles ButtonSimpan.Click
        ...
        Call conecDB()
        Try
            comDB = New MySql.Data.MySqlClient.MySqlCommand("INSERT INTO toko (nama_toko,telepon,alamat) values ('" + TextBoxNamaToko.Text + "','" + TextBoxNoTelepon.Text + "','" + TextBoxAlamat.Text + "')", connDB)
            comDB.ExecuteNonQuery()
