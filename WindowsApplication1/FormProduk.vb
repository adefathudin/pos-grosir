Public Class FormProduk
    ...
    Public Sub load_data_produk(query)
        ...
        Else
            da = New MySql.Data.MySqlClient.MySqlDataAdapter("SELECT prdcd,desc2,stok,rak FROM prodmast where prdcd like '%" + query + "%' or singkatan like '%" + query + "%' or desc2 like '%" + query + "%' or rak like '%" + query + "%' or price_kat like '%" + query + "%'", connDB)
        End If
        Try
